    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
         ...
         <!-- /.row -->
            ...
            $query = "SELECT * FROM users WHERE user_role = 'subsciber'";
           ...
           <script type="text/javascript">
            ...
            function drawChart() {
              var data = google.visualization.arrayToDataTable([
                ...
                $element_count = [$post_counts, $post_draft_counts, $comment_counts, $unapproved_comment_count, $user_counts, $subscriber_count, $categories_counts];
                for($i =0; $i < 7; $i++)
                {
